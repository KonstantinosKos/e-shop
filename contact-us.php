...
<body style="background-color: rgb(216, 216, 216);;">
    <div>
        ...
        <div style="margin-left: 10%; margin-right: 10%;">
            <b>
                The e-shop.gr places great importance on customer feedback. We gladly welcome any criticism from our
                customers,
            ...
            <div style=" display: flex; margin-top:5%;">
                ...
                <div>
                    <b style="color: #000;">For the sales department, for submitting or modifying an order:
                        <a href="mailto: eshop-sales@gmail.com">eshop-sales@gmail.com</a>
                        </hp>
                </div>
            </div>
