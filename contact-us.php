...
<body style="background-color: rgb(216, 216, 216);">
    <div >
        <div>
            <nav class="navbar navbar-expand-lg navbar-light" id="navigation">
                <div class="container-fluid">
                    <a class="navbar-brand" href="index.php" style="margin-left: 10%; color: white;">E-Shop</a>
        ...
        <div style="margin-left: 10%; margin-right: 10%;">
            <b>
                The e-shop.gr places great importance on customer feedback. We gladly welcome any criticism from our customers,
                 always listening carefully and responding to everyone. For products that are not found on our website,
                  you can request them via email.
                <a href="mailto: eshop-sales@gmail.com">eshop-sales@gmail.com</a> ή
                By phone from 9:00 am to 9:00 pm at 211 512 6 521.            
            </b>
            <b>
            ...
            <div style=" display: flex; margin-top:5%;">
                ...
                <div>
                    <b style="color: #000;">For the sales department, for submitting or modifying an order:
                        <a
            ...
            <div style=" display: flex; margin-top:1%;">
                ...
                <div>
                    <p style="color: #000;">For issues related to the handling of your order:
            ...
            <div style=" display: flex; margin-top:0%;">
                ...
                <div>
                    <p style="color: #000;">
                        For the service department, in case of a defective product: <a
